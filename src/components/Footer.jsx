...
const Footer = () => {
  return (
    <>
        ...
        {/*    <!-- Main footer --> */}
        <div className="pt-16 pb-12 text-sm border-t border-orange-600 bg-orange-500">
              ...
              >
                ...
                <ul>
                  <li className="mb-2 leading-6">
                    <a
                      href="#"
                      className="transition-colors duration-300 hover:text-orange-100 focus:text-orange-50"
                    >
                      Features
                    </a>
                  </li>
        ...
        {/*    <!-- Subfooter --> */}
        <div className="py-4 text-sm border-t border-orange-700 bg-orange-600">
          <div className="container px-6 mx-auto">
            <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
                ...
                <ul className="flex items-center justify-end gap-4">
                  <li>
                    <a
                      ...
                      className="transition-colors duration-300 hover:text-orange-100"
                    >
                      <svg
